...
- 별칭 규칙(→ 정규명칭): 리쥬더마크림→리쥬더마, 마이어스2→마이어스2, 마이어스→마이어스1, 도수2/도수치료2→도수2, 도수1/도수치료1/림프도수→도수1, 세파셀렌정→셀레나제정, 고함량비타민C/IVC→고용량비타민C, 이스카도→이스카도M, 페리주 단독→페리주, 고주파온열치료→고주파, 닥터라민+미네랄/닥터라민미네랄→닥터라민
