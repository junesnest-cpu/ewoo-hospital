...
- 시간 정규화 규칙 (모든 변형을 3가지로 통일):
  ...
  "저녁 후" ← 저녁후/저녁 후/저녁식사 후/저녁때/석식 후/저녁밥 후/야간/밤
- "아침후 퇴원" / "오전 퇴원" → dischargeTime: "아침 후"
- "점심후 퇴원" / "오후 퇴원" / "낮에 퇴원" → dischargeTime: "점심 후"
- "저녁후 퇴원" / "저녁때 퇴원" → dischargeTime: "저녁 후"
- ★ 식사 기준 입원 시간: "X먹으러/X식사 입원" = X를 먹으려면 그 전에 도착해야 함
  "점심먹으러 입원" / "점심식사 입원" → admitTime: "아침 후" (점심 전 도착)
  "저녁먹으러 입원" / "저녁식사 입원" / "저녁식사 재입원" / "저녁먹으러 재입원" / "저녁밥 재입원" → admitTime: "점심 후" (저녁 전 도착)
  "저녁식사부터 드신다" / "저녁부터 식사" → admitTime: "점심 후" (저녁 식사 전 도착)
  "점심식사부터 드신다" / "점심부터 식사" → admitTime: "아침 후" (점심 식사 전 도착)
- ★ 식사와 무관한 시간대 표현:
  "오전입원" / "오전 입원" / "아침 입원" / "아침후 입원" → admitTime: "아침 후"
  "오후 입원" / "점심후 입원" / "점심 재입원" → admitTime: "점심 후"
  "저녁후 입원" / "저녁 입원" / "저녁후 재입원" → admitTime: "저녁 후"
