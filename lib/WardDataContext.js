...
export function WardDataProvider({ children }) {
  ...
  }), [slots, consultations, patients, newPatientFlags, settings, logs, pendingCount, emrSyncTime, slotsLoaded, nameToSlotRoom, namesInSlots, saveSlots, addLog, recordDischarge, syncConsultationOnSlotChange]);
