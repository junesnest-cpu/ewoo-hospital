...
export function WardDataProvider({ children }) {
  ...
  const value = useMemo(() => ({
    ...
    cleanupDailyBoards,
  }), [slots, consultations, patients, newPatientFlags, settings, logs, pendingCount, emrSyncTime, slotsLoaded, nameToSlotRoom, namesInSlots, saveSlots, addLog, recordDischarge, syncConsultationOnSlotChange, cleanupDailyBoards]);
